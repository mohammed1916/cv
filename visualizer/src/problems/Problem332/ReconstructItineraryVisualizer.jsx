...
const SOLUTION_CODE = [
  { line: 1, text: '# Solution for Reconstruct Itinerary' },
...
const EXAMPLES = getExamples('reconstruct-itinerary') || []
...
export default function ReconstructItineraryVisualizer() {
  ...
  const renderVisualization = () => {
    if (!input) return <div className="reconstruct-itinerary-error">{inputError}</div>
    ...
    return (
      ...
      >
        <div className="reconstruct-itinerary-step-info">
  ...
  return (
    <div className="reconstruct-itinerary-shell">
      <ResizableSplitPanels
        left={
          <div className="reconstruct-itinerary-panel reconstruct-itinerary-panel-input">
            <div className="reconstruct-itinerary-panel-head">Input</div>
        ...
        right={
          <div className="reconstruct-itinerary-panel reconstruct-itinerary-panel-viz">
      ...
      <div className="reconstruct-itinerary-middle">
        <div className="reconstruct-itinerary-panel">
          <div className="reconstruct-itinerary-panel-head">Code Trace</div>
          <div className="reconstruct-itinerary-panel-body">
        ...
        <div className="reconstruct-itinerary-panel">
          <div className="reconstruct-itinerary-panel-head">Examples</div>
          <div className="reconstruct-itinerary-panel-body reconstruct-itinerary-examples">
      ...
      <div className="reconstruct-itinerary-bottom">
