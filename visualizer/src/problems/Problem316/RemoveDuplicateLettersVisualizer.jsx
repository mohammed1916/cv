...
const EXAMPLES = getExamples('remove-duplicate-letters') || []
...
export default function RemoveDuplicateLettersVisualizer() {
  ...
  return (
    <div className="remove-duplicate-letters-shell">
      ...
      <div className="remove-duplicate-letters-middle">
        <div className="remove-duplicate-letters-panel">
          <div className="remove-duplicate-letters-panel-head">Code Trace</div>
          <div className="remove-duplicate-letters-panel-body">
        ...
        <div className="remove-duplicate-letters-panel">
          <div className="remove-duplicate-letters-panel-head">Examples</div>
          <div className="remove-duplicate-letters-panel-body remove-duplicate-letters-examples">
      ...
      <div className="remove-duplicate-letters-bottom">
        <PlaybackControls
          isPlaying={isPlaying}
