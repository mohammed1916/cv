...
import './FindMedianGivenFrequencyVisualizer.css'
...
const EXAMPLES = getExamples('find-median-given-frequency')
...
export default function FindMedianGivenFrequencyVisualizer() {
  ...
  return (
    <div className="findMedianGivenFrequency-root">
      <div className="findMedianGivenFrequency-card findMedianGivenFrequency-input-card">
        <div className="findMedianGivenFrequency-input-row">
          <div className="findMedianGivenFrequency-field-group">
            <label className="findMedianGivenFrequency-input-label">Input</label>
            <input className="findMedianGivenFrequency-input" value={input} onChange={(e) => setInput(e.target.value)} placeholder="Enter input" />
          </div>
          <button className="findMedianGivenFrequency-btn findMedianGivenFrequency-btn-primary" onClick={handleVisualize}>
            Visualize
          </button>
        </div>
      </div>
