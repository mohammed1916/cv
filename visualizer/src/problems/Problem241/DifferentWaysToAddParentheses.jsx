...
const EXAMPLES = getExamples('different-ways-to-add-parentheses') || []
  ...
  return (
    <div className="different-ways-to-add-parentheses-shell">
      <ResizableSplitPanels
        className="different-ways-to-add-parentheses-top-split"
        storageKey="cpviz.split.different-ways-to-add-parentheses.top"
        initialLeftPercent={60}
        minLeftPx={360}
        minRightPx={280}
        left={(
          <div className="different-ways-to-add-parentheses-panel">
