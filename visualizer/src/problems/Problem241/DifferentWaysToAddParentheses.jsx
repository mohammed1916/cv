...
export default function DifferentWaysToAddParentheses() {
  ...
  const panelContents = {
    left: (<div className="vis-panel different-ways-to-add-parentheses-panel">
            <div className="vis-panel-head different-ways-to-add-parentheses-panel-head">
              Input
              {inputError && <span style={{ color: '#ea0c0c', marginLeft: 8 }}>{inputError}</span>}
            </div>
            <div className="vis-panel-body different-ways-to-add-parentheses-panel-body">
              <div style={{ display: 'flex', gap: 6, marginBottom: 16, flexWrap: 'wrap' }}>
                {EXAMPLES.map((ex) => (
                  <button
                    key={ex.label}
                    onClick={() => applyExample(ex)}
                    className="vis-example-btn different-ways-to-add-parentheses-example-btn"
                  >
                    {ex.label}
                  </button>
                ))}
    ...
    right: (<div className="vis-panel different-ways-to-add-parentheses-panel">
            <div className="vis-panel-head different-ways-to-add-parentheses-panel-head">Details</div>
            <div className="vis-panel-body different-ways-to-add-parentheses-panel-body">
