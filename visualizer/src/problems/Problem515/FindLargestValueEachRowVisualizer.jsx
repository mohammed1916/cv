  ...
  return (
    <g key={`tree-${node.val}-${x}-${y}`}>
      ...
      <motion.circle
        ...
        cy={y}
        r="28"
        fill={isCurrent ? '#fbcfe8' : inLevel ? '#fbcfe8' : 'var(--surface2)'}
        stroke={isCurrent ? '#ec4899' : inLevel ? '#f472b6' : 'var(--border)'}
      ...
      <text
        ...
        fontSize="14"
        fontWeight="600"
        fill={isCurrent || inLevel ? '#be185d' : 'var(--border)'}
      >
        {node.val}
      </text>
    </g>
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 20, padding: 16 }}>
      ...
      >
        ...
        <div style={{ fontSize: 18, fontWeight: 'bold', color: '#e0177a' }}>
...
export default function FindLargestValueEachRowVisualizer() {
  ...
  const panelConfigs = useMemo(() => [
    { id: 'code', title: 'Code' },
    { id: 'viz', title: '🌳 Largest Value per Row', dockMode: 'split-right' },
  ], [])
