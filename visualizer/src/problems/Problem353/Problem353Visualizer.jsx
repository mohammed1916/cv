...
export default function Problem353Visualizer() {
  ...
  const panelConfigs = useMemo(() => [
    { id: 'code', title: 'Code' },
    { id: 'viz', title: '🚇 Underground System', dockMode: 'split-right' },
  ], [])
  ...
  return (
    <div className="problem-shell">
        <ManualInputPanel
          fields={[{"key":"events","label":"events","type":"array"}]}
          values={{ events: eventsInput }}
          onChange={(k, v) => { if (k === 'events') setEventsInput(v); handleReset() }}
          examples={EXAMPLES}
