      ...
      {step?.tempDivisor !== undefined && step.phase === 'find_multiple' && (
        <div style={{ padding: 12, backgroundColor: 'var(--surface2)', borderRadius: 6, border: '2px solid #f59e0b' }}>
          ...
          <div style={{ fontSize: 12, color: '#5577a4', fontFamily: 'monospace' }}>
            ...
            {' '} | Multiple: <span style={{ color: '#178740', fontWeight: 600 }}>{step.multiple}</span>
          </div>
        </div>
      )}
  ...
  const panelContents = useMemo(() => ({
    ...
    viz: (<div style={{ display: 'flex', flexDirection: 'column', height: '100%', gap: 12 }}>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8 }}>
              <div>
                <div style={{ fontSize: 12, fontWeight: 600, color: '#5577a4', marginBottom: 6 }}>Dividend</div>
                <input
                  type="number"
                  value={dividend}
                  onChange={(e) => {
              ...
              <div>
                <div style={{ fontSize: 12, fontWeight: 600, color: '#5577a4', marginBottom: 6 }}>Divisor</div>
                <input
                  type="number"
                  value={divisor}
                  onChange={(e) => {
