...
import './EmployeeBonusVisualizer.css'
...
const EXAMPLES = getExamples('employee-bonus')
...
export default function EmployeeBonusVisualizer() {
  ...
  return (
    <div className="employeeBonus-root">
      <div className="employeeBonus-card employeeBonus-input-card">
        <div className="employeeBonus-input-row">
          <div className="employeeBonus-field-group">
            <label className="employeeBonus-input-label">Input</label>
            <input className="employeeBonus-input" value={input} onChange={(e) => setInput(e.target.value)} placeholder="Enter input" />
          </div>
          <button className="employeeBonus-btn employeeBonus-btn-primary" onClick={handleVisualize}>
            Visualize
          </button>
        </div>
      </div>
