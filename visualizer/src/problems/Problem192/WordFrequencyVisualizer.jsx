...
import './WordFrequencyVisualizer.css'
...
const EXAMPLES = getExamples('word-frequency')

export default function WordFrequencyVisualizer() {
  ...
  return (
    <div className="word_frequency-shell">
      <ResizableSplitPanels
        className="word_frequency-top-split"
        storageKey="cpviz.split.word-frequency.top"
        initialLeftPercent={60}
        minLeftPx={360}
        minRightPx={280}
        left={(
          <div className="word_frequency-panel">
            ...
            <div className="word_frequency-panel-body">
              <div style={{ display: "flex", gap: 6, marginBottom: 16, flexWrap: "wrap" }}>
                {EXAMPLES?.map((ex) => (
                  <button
                    ...
                    className="word_frequency-example-btn"
                  >
                    {ex.label}
                  </button>
                )) || null}
              ...
              <div style={{ display: "flex", gap: 12, marginBottom: 24 }}>
                <input
                  ...
                  className="word_frequency-input"
                  style={{ flex: 1 }}
                />
              </div>

              <div className="word_frequency-visualization">
      ...
      <div className={`word_frequency-status ${step?.phase === "done" ? "success" : ""}`}>
        {step?.message ?? "Press Play or Step to begin."}
      </div>

      <div className="word_frequency-dock">
        <PlaybackControls
          isPlaying={isPlaying}
          isDone={isDone}
          speed={speed}
