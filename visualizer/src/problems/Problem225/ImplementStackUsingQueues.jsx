...
const EXAMPLES = getExamples('implement-stack-using-queues') || []
  ...
  return (
    <div className="implement-stack-using-queues-shell">
      <ResizableSplitPanels
        className="implement-stack-using-queues-top-split"
        storageKey="cpviz.split.implement-stack-using-queues.top"
        initialLeftPercent={60}
        minLeftPx={360}
        minRightPx={280}
        left={(
          <div className="implement-stack-using-queues-panel">
