  ...
  return (
    <div className="csatbst-state-panel">
      ...
      <div className="csatbst-metric">
        ...
        <strong className="csatbst-val">
          {step?.createdNodeIds?.size ?? 0}
        </strong>
      </div>
      <div className="csatbst-legend">
        <div className="csatbst-legend-item">
          <div className="csatbst-dot active" />
          Current node
        </div>
        <div className="csatbst-legend-item">
          <div className="csatbst-dot created" />
          Created node
        </div>
      </div>
    </div>
