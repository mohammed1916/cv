...
import './Problem292Visualizer.css'
...
export default function Problem292Visualizer() {
    const examples = useMemo(() => getExamplesOr('292', []), [])
    ...
    return (
        ...
        >
            ...
            <FloatingPanel title="Visualization" position="main">
                <div className="problem292-visualizer-viz-panel">
                    <div className="problem292-visualizer-canvas">
                        <motion.div
                            initial={{ opacity: 0 }}
                            animate={{ opacity: 1 }}
