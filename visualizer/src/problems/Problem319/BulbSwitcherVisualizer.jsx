...
const SOLUTION_CODE = [
  { line: 1, text: '# Solution for Bulb Switcher' },
...
export default function BulbSwitcherVisualizer() {
  ...
  const renderVisualization = () => {
    if (!input) return <div className="bulb-switcher-error">{inputError}</div>
  ...
  return (
    <div className="bulb-switcher-shell">
      <ResizableSplitPanels
        ...
        right={
          <div className="bulb-switcher-panel bulb-switcher-panel-viz">
      ...
      <div className="bulb-switcher-middle">
        <div className="bulb-switcher-panel">
          <div className="bulb-switcher-panel-head">Code Trace</div>
          <div className="bulb-switcher-panel-body">
        ...
        <div className="bulb-switcher-panel">
          <div className="bulb-switcher-panel-head">Examples</div>
          <div className="bulb-switcher-panel-body bulb-switcher-examples">
      ...
      <div className="bulb-switcher-bottom">
        <PlaybackControls
          isPlaying={isPlaying}
