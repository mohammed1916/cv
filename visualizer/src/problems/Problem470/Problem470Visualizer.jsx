...
const SOLUTION_CODE = getSolutionCode('implement-rand10')
...
export default function Problem470Visualizer() {
  ...
  const panelConfigs = useMemo(() => [
    { id: 'code', title: 'Code' },
    { id: 'viz', title: '🎲 Implement Rand10()', dockMode: 'split-right' },
  ], [])
  ...
  return (
    <div className="problem-shell">
        <ManualInputPanel
          fields={[{"key":"calls","label":"calls","type":"string"}]}
          values={{ calls: callsInput }}
          onChange={(k, v) => { if (k === 'calls') setCallsInput(v); handleReset() }}
          examples={EXAMPLES}
