...
const SOLUTION_CODE = [
  { line: 1, text: '# Solution for Patching Array' },
...
const EXAMPLES = getExamples('patching-array') || []
  ...
  return (
    <div className="patching-array-shell">
      <ResizableSplitPanels
        left={
          <div className="patching-array-panel patching-array-panel-input">
        ...
        right={
          <div className="patching-array-panel patching-array-panel-viz">
      ...
      <div className="patching-array-middle">
        <div className="patching-array-panel">
          <div className="patching-array-panel-head">Code Trace</div>
          <div className="patching-array-panel-body">
      ...
      <div className="patching-array-bottom">
