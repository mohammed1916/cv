  ...
  return (
    <div className="majority_element-shell">
      <ResizableSplitPanels
        className="majority_element-top-split"
        storageKey="cpviz.split.majority-element.top"
            ...
            <div className="majority_element-panel-body">
              <div style={{ display: "flex", gap: 6, marginBottom: 16, flexWrap: "wrap" }}>
                {EXAMPLES?.map((ex) => (
                  <button
                    ...
                    className="majority_element-example-btn"
                  >
                    {ex.label}
                  </button>
                )) || null}
              ...
              <div style={{ display: "flex", gap: 12, marginBottom: 24 }}>
                <input
                  ...
                  className="majority_element-input"
                  style={{ flex: 1 }}
                />
              </div>

              <div className="majority_element-visualization">
      ...
      <div className={`majority_element-status ${step?.phase === "done" ? "success" : ""}`}>
        {step?.message ?? "Press Play or Step to begin."}
      </div>

      <div className="majority_element-dock">
        <PlaybackControls
          isPlaying={isPlaying}
          isDone={isDone}
          speed={speed}
