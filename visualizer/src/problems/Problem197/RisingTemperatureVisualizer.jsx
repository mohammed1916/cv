...
import './RisingTemperatureVisualizer.css'
...
const EXAMPLES = getExamples('rising-temperature')

export default function RisingTemperatureVisualizer() {
  ...
  return (
    <div className="rising_temperature-shell">
            ...
            <div className="rising_temperature-panel-body">
              <div style={{ display: "flex", gap: 6, marginBottom: 16, flexWrap: "wrap" }}>
                {EXAMPLES?.map((ex) => (
                  <button
                    ...
                    className="rising_temperature-example-btn"
                  >
                    {ex.label}
                  </button>
                )) || null}
              ...
              <div style={{ display: "flex", gap: 12, marginBottom: 24 }}>
                <input
                  ...
                  className="rising_temperature-input"
                  style={{ flex: 1 }}
                />
              </div>

              <div className="rising_temperature-visualization">
      ...
      <div className={`rising_temperature-status ${step?.phase === "done" ? "success" : ""}`}>
        {step?.message ?? "Press Play or Step to begin."}
      </div>

      <div className="rising_temperature-dock">
        <PlaybackControls
          isPlaying={isPlaying}
          isDone={isDone}
          speed={speed}
