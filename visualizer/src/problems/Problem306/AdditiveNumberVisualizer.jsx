...
const SOLUTION_CODE = [
  { line: 1, text: '# Solution for Additive Number' },
...
const EXAMPLES = getExamplesOr('additive-number', [])

export default function AdditiveNumberVisualizer() {
  ...
  const renderVisualization = () => {
    if (!input) return <div className="additive-number-error">{inputError}</div>

    const currentStepData = step || {}

    return (
      <motion.div
        className="additive-number-viz"
        key={stepIndex}
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        exit={{ opacity: 0 }}
      ...
      >
        <div className="additive-number-step-info">
    ...
    <div className="additive-number-shell">
          ...
          <div className="additive-number-panel additive-number-panel-input">
            ...
            <div className="additive-number-panel-body">
              <textarea
                ...
                className="additive-number-textarea"
      ...
      <div className="additive-number-middle">
        <div className="additive-number-panel">
          <div className="additive-number-panel-head">Code Trace</div>
          <div className="additive-number-panel-body">
        ...
        <div className="additive-number-panel">
          <div className="additive-number-panel-head">Examples</div>
          <div className="additive-number-panel-body additive-number-examples">
            {EXAMPLES.map((example, i) => (
              <button
                key={i}
                className="additive-number-example-btn"
      ...
      <div className="additive-number-bottom">
