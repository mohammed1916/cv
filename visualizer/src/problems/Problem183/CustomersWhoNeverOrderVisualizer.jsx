...
const SOLUTION_CODE = [
  { line: 1, text: "// CustomersWhoNeverOrder" },
  ...
  return (
    <div className="customers_who_never_order-shell">
      <ResizableSplitPanels
        className="customers_who_never_order-top-split"
        storageKey="cpviz.split.customers-never-order.top"
        initialLeftPercent={60}
        minLeftPx={360}
        minRightPx={280}
        left={(
          <div className="customers_who_never_order-panel">
      ...
      <div className="customers_who_never_order-dock">
        <PlaybackControls
          isPlaying={isPlaying}
          isDone={isDone}
          speed={speed}
