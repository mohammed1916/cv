...
import './OutOfBoundaryPathsVisualizer.css'
...
const EXAMPLES = getExamples('out-of-boundary-paths')
...
export default function OutOfBoundaryPathsVisualizer() {
  ...
  return (
    <div className="outOfBoundaryPaths-root">
      <div className="outOfBoundaryPaths-card outOfBoundaryPaths-input-card">
        <div className="outOfBoundaryPaths-input-row">
          <div className="outOfBoundaryPaths-field-group">
            <label className="outOfBoundaryPaths-input-label">Input</label>
            <input className="outOfBoundaryPaths-input" value={input} onChange={(e) => setInput(e.target.value)} placeholder="Enter input" />
          </div>
          <button className="outOfBoundaryPaths-btn outOfBoundaryPaths-btn-primary" onClick={handleVisualize}>
            Visualize
          </button>
        </div>
      </div>
