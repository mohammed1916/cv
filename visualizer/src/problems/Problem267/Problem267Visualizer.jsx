...
const SOLUTION_CODE = [
    ...
    { line: 2, text: '# Generate all palindrome permutations.' },
...
function generateSteps(input) {
    ...
    steps.push({
        phase: 'init',
        activeLine: 1,
        message: 'Start: Generate all palindrome permutations.',
...
export default function Problem267Visualizer() {
    const examples = useMemo(() => getExamples('267') || [], [])
    ...
    return (
        <DockableWorkspace
            ...
            subtitle="palindrome-permutation-ii"
            accentColor="#14b8a6"
        >
