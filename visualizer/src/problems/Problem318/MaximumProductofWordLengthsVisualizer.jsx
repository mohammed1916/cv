...
const EXAMPLES = getExamples('max-product-word-lengths') || []
  ...
  return (
    <div className="maximum-productof-word-lengths-shell">
      <ResizableSplitPanels
        left={
          <div className="maximum-productof-word-lengths-panel maximum-productof-word-lengths-panel-input">
        ...
        right={
          <div className="maximum-productof-word-lengths-panel maximum-productof-word-lengths-panel-viz">
      ...
      <div className="maximum-productof-word-lengths-middle">
        <div className="maximum-productof-word-lengths-panel">
          <div className="maximum-productof-word-lengths-panel-head">Code Trace</div>
          <div className="maximum-productof-word-lengths-panel-body">
        ...
        <div className="maximum-productof-word-lengths-panel">
          <div className="maximum-productof-word-lengths-panel-head">Examples</div>
          <div className="maximum-productof-word-lengths-panel-body maximum-productof-word-lengths-examples">
      ...
      <div className="maximum-productof-word-lengths-bottom">
