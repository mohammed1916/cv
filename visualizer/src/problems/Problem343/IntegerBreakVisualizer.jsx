...
const SOLUTION_CODE = [
  { line: 1, text: '# Solution for Integer Break' },
...
const EXAMPLES = getExamples('integer-break') || []
...
export default function IntegerBreakVisualizer() {
  ...
  const renderVisualization = () => {
    if (!input) return <div className="integer-break-error">{inputError}</div>
  ...
  return (
    <div className="integer-break-shell">
      <ResizableSplitPanels
        left={
          <div className="integer-break-panel integer-break-panel-input">
            <div className="integer-break-panel-head">Input</div>
        ...
        right={
          <div className="integer-break-panel integer-break-panel-viz">
            <div className="integer-break-panel-head">Visualization</div>
            <div className="integer-break-panel-body">
      ...
      <div className="integer-break-middle">
        <div className="integer-break-panel">
          <div className="integer-break-panel-head">Code Trace</div>
          <div className="integer-break-panel-body">
        ...
        <div className="integer-break-panel">
          <div className="integer-break-panel-head">Examples</div>
          <div className="integer-break-panel-body integer-break-examples">
      ...
      <div className="integer-break-bottom">
