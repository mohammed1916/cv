...
import './DeleteOperationForTwoStringsVisualizer.css'
...
const EXAMPLES = getExamples('delete-operation-for-two-strings')
...
export default function DeleteOperationForTwoStringsVisualizer() {
  ...
  return (
    <div className="deleteOperationForTwoStrings-root">
      <div className="deleteOperationForTwoStrings-card deleteOperationForTwoStrings-input-card">
        <div className="deleteOperationForTwoStrings-input-row">
          <div className="deleteOperationForTwoStrings-field-group">
            <label className="deleteOperationForTwoStrings-input-label">Input</label>
            <input className="deleteOperationForTwoStrings-input" value={input} onChange={(e) => setInput(e.target.value)} placeholder="Enter input" />
          </div>
          <button className="deleteOperationForTwoStrings-btn deleteOperationForTwoStrings-btn-primary" onClick={handleVisualize}>
            Visualize
          </button>
        </div>
      </div>
