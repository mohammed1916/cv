            ...
            return (
              <motion.div
                ...
                style={{
                  ...
                  height: 32,
                  borderRadius: 4,
                  backgroundColor: isActive ? '#dc2626' : char === ' ' ? 'var(--surface2)' : '#dbeafe',
                  border: isActive ? '2px solid #991b1b' : char === ' ' ? '1px solid var(--border)' : '2px solid #0284c7',
                  display: 'flex',
                  alignItems: 'center',
                  justifyContent: 'center',
                  fontSize: 11,
                  fontWeight: 700,
                  color: isActive ? '#white' : char === ' ' ? 'var(--text-muted)' : '#0c4a6e',
                }}
...
export default function Problem439Visualizer() {
  ...
  const panelConfigs = useMemo(() => [
    { id: 'code', title: 'Code' },
    { id: 'viz', title: '🤔 Parser', dockMode: 'split-right' },
  ], [])
