...
export default function CreateMaximumNumberVisualizer() {
  ...
  const panelContents = {
    left: (<div className="create-maximum-number-panel create-maximum-number-panel-input">
    ...
    right: (<div className="create-maximum-number-panel create-maximum-number-panel-viz">
