...
const EXAMPLES = getExamples('squirrel-distribution')
...
export default function SquirrelDistributionVisualizer() {
  ...
  return (
    <div className="squirrelDistribution-root">
      <div className="squirrelDistribution-card squirrelDistribution-input-card">
        <div className="squirrelDistribution-input-row">
          <div className="squirrelDistribution-field-group">
            <label className="squirrelDistribution-input-label">Input</label>
            <input className="squirrelDistribution-input" value={input} onChange={(e) => setInput(e.target.value)} placeholder="Enter input" />
          </div>
          <button className="squirrelDistribution-btn squirrelDistribution-btn-primary" onClick={handleVisualize}>
            Visualize
          </button>
        </div>
      </div>
