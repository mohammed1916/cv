...
const EXAMPLES = getExamples('linked-list-cycle-ii') || [
  ...
  const dockPanels = useMemo(
    () => [
      ...
      },
      {
        id: 'viz',
        title: '🔗 Cycle II',
        content: <VisualizationPanel step={step} nodes={input.nodes} cycleStart={input.pos} />,
      },
    ],
    [step, connectivity, setActiveLineDom, input]
  )
