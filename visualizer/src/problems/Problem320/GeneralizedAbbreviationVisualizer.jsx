...
export default function GeneralizedAbbreviationVisualizer() {
  ...
  const renderVisualization = () => {
    if (!input) return <div className="generalized-abbreviation-error">{inputError}</div>
  ...
  return (
    <div className="generalized-abbreviation-shell">
      <ResizableSplitPanels
        left={
          <div className="generalized-abbreviation-panel generalized-abbreviation-panel-input">
        ...
        right={
          <div className="generalized-abbreviation-panel generalized-abbreviation-panel-viz">
      ...
      <div className="generalized-abbreviation-middle">
        <div className="generalized-abbreviation-panel">
          <div className="generalized-abbreviation-panel-head">Code Trace</div>
          <div className="generalized-abbreviation-panel-body">
        ...
        <div className="generalized-abbreviation-panel">
          <div className="generalized-abbreviation-panel-head">Examples</div>
          <div className="generalized-abbreviation-panel-body generalized-abbreviation-examples">
      ...
      <div className="generalized-abbreviation-bottom">
        <PlaybackControls
          isPlaying={isPlaying}
