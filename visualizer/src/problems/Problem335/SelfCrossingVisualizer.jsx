...
const SOLUTION_CODE = [
  { line: 1, text: '# Solution for Self Crossing' },
...
const EXAMPLES = getExamples('self-crossing') || []
...
export default function SelfCrossingVisualizer() {
  ...
  const renderVisualization = () => {
    if (!input) return <div className="self-crossing-error">{inputError}</div>
    ...
    return (
      ...
      >
        <div className="self-crossing-step-info">
  ...
  return (
    <div className="self-crossing-shell">
      <ResizableSplitPanels
        left={
          <div className="self-crossing-panel self-crossing-panel-input">
            <div className="self-crossing-panel-head">Input</div>
        ...
        right={
          <div className="self-crossing-panel self-crossing-panel-viz">
      ...
      <div className="self-crossing-middle">
        <div className="self-crossing-panel">
          <div className="self-crossing-panel-head">Code Trace</div>
          <div className="self-crossing-panel-body">
        ...
        <div className="self-crossing-panel">
          <div className="self-crossing-panel-head">Examples</div>
          <div className="self-crossing-panel-body self-crossing-examples">
      ...
      <div className="self-crossing-bottom">
