...
export default function MaximumSizeSubarraySumEqualskVisualizer() {
  ...
  const panelConfigs = useMemo(() => [{ id: 'input', title: 'Input' }, { id: 'code', title: 'Python code', dockMode: 'split-right' }, { id: 'viz', title: 'Prefix-sum trace', dockMode: 'split-right' }, { id: 'state', title: 'Remembered prefixes', dockMode: 'split-bottom' }], [])
