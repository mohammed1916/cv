  ...
  return (
    <g key={`tree-${node.val}-${x}-${y}`}>
      ...
      <motion.circle
        ...
        cy={y}
        r="28"
        fill={isResult ? '#cffafe' : isActive ? '#dbeafe' : inQueue ? '#d1fae5' : 'var(--surface2)'}
        stroke={isResult ? '#06b6d4' : isActive ? '#0284c7' : inQueue ? '#10b981' : 'var(--border)'}
      ...
      <text
        ...
        fontSize="14"
        fontWeight="600"
        fill={isResult ? '#164e63' : isActive ? '#0c4a6e' : inQueue ? '#047857' : 'var(--border)'}
      >
        {node.val}
      </text>
    </g>
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 20, padding: 16 }}>
      ...
      >
        ...
        <div style={{ fontSize: 24, fontWeight: 'bold', color: '#027bba' }}>
...
export default function FindBottomLeftTreeValueVisualizer() {
  ...
  const panelConfigs = useMemo(() => [
    { id: 'code', title: 'Code' },
    { id: 'viz', title: '🌳 Bottom Left Tree Value', dockMode: 'split-right' },
  ], [])
