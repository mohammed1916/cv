...
const SOLUTION_CODE = [
  { line: 1, text: '# Solution for Longest Substring with At Most K Distinct Characters' },
...
const EXAMPLES = getExamples('longest-substring-k-distinct') || []
...
export default function LongestSubstringwithAtMostKDistinctCharactersVisualizer() {
  ...
  const renderVisualization = () => {
    if (!input) return <div className="longest-substringwith-at-most-k-distinct-characters-error">{inputError}</div>
  ...
  return (
    <div className="longest-substringwith-at-most-k-distinct-characters-shell">
      <ResizableSplitPanels
        left={
          <div className="longest-substringwith-at-most-k-distinct-characters-panel longest-substringwith-at-most-k-distinct-characters-panel-input">
        ...
        right={
          <div className="longest-substringwith-at-most-k-distinct-characters-panel longest-substringwith-at-most-k-distinct-characters-panel-viz">
      ...
      <div className="longest-substringwith-at-most-k-distinct-characters-middle">
        <div className="longest-substringwith-at-most-k-distinct-characters-panel">
          <div className="longest-substringwith-at-most-k-distinct-characters-panel-head">Code Trace</div>
          <div className="longest-substringwith-at-most-k-distinct-characters-panel-body">
        ...
        <div className="longest-substringwith-at-most-k-distinct-characters-panel">
          <div className="longest-substringwith-at-most-k-distinct-characters-panel-head">Examples</div>
          <div className="longest-substringwith-at-most-k-distinct-characters-panel-body longest-substringwith-at-most-k-distinct-characters-examples">
      ...
      <div className="longest-substringwith-at-most-k-distinct-characters-bottom">
        <PlaybackControls
          isPlaying={isPlaying}
