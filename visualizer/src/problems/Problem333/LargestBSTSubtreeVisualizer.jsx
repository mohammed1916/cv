...
const SOLUTION_CODE = [
  { line: 1, text: '# Solution for Largest BST Subtree' },
...
const EXAMPLES = getExamples('largest-bst-subtree') || []
...
export default function LargestBSTSubtreeVisualizer() {
  ...
  const renderVisualization = () => {
    if (!input) return <div className="largest-b-s-t-subtree-error">{inputError}</div>
  ...
  return (
    <div className="largest-b-s-t-subtree-shell">
      <ResizableSplitPanels
        left={
          <div className="largest-b-s-t-subtree-panel largest-b-s-t-subtree-panel-input">
            <div className="largest-b-s-t-subtree-panel-head">Input</div>
        ...
        right={
          <div className="largest-b-s-t-subtree-panel largest-b-s-t-subtree-panel-viz">
      ...
      <div className="largest-b-s-t-subtree-middle">
        <div className="largest-b-s-t-subtree-panel">
          <div className="largest-b-s-t-subtree-panel-head">Code Trace</div>
          <div className="largest-b-s-t-subtree-panel-body">
        ...
        <div className="largest-b-s-t-subtree-panel">
          <div className="largest-b-s-t-subtree-panel-head">Examples</div>
          <div className="largest-b-s-t-subtree-panel-body largest-b-s-t-subtree-examples">
      ...
      <div className="largest-b-s-t-subtree-bottom">
