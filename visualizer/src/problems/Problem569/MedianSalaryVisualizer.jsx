...
import './MedianSalaryVisualizer.css'
...
const EXAMPLES = getExamples('median-salary')
...
export default function MedianSalaryVisualizer() {
  ...
  return (
    <div className="medianSalary-root">
      <div className="medianSalary-card medianSalary-input-card">
        <div className="medianSalary-input-row">
          <div className="medianSalary-field-group">
            <label className="medianSalary-input-label">Input</label>
            <input className="medianSalary-input" value={input} onChange={(e) => setInput(e.target.value)} placeholder="Enter input" />
          </div>
          <button className="medianSalary-btn medianSalary-btn-primary" onClick={handleVisualize}>
            Visualize
          </button>
        </div>
      </div>
