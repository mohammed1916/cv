...
const SOLUTION_CODE = [
  { line: 1, text: "// SecondHighestSalary" },
  ...
  return (
    <div className="second_highest_salary-shell">
      <ResizableSplitPanels
        className="second_highest_salary-top-split"
        storageKey="cpviz.split.second-highest-salary.top"
      ...
      <div className="second_highest_salary-dock">
        <PlaybackControls
          isPlaying={isPlaying}
          isDone={isDone}
          speed={speed}
