  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 16, padding: 16, height: '100%', overflow: 'auto' }}>
      ...
      {step?.result !== undefined && (
        ...
        >
          <div style={{ fontSize: 12, fontWeight: 600, color: 'var(--text-muted)', marginBottom: 8 }}>Minimum Difference</div>
...
export default function MinimumTimeDifferenceVisualizer() {
  ...
  const panelConfigs = useMemo(() => [
    { id: 'code', title: 'Code' },
    { id: 'viz', title: '⏱ Minimum Time Difference', dockMode: 'split-right' },
  ], [])
  const panelContents = useMemo(() => ({
    ...
    viz: (<VisualizationPanel times={times} step={step} applyExample={applyExample} examples={examples} />),
