...
export default function RemoveLinkedListElementsVisualizer() {
  ...
  const panelConfigs = useMemo(() => [
    { id: 'code', title: "Code" },
    { id: 'viz', title: "🔗 Remove Elements", dockMode: 'split-right' },
  ], [])
  ...
  return (
    <div className="problem-shell">
        <ManualInputPanel
          fields={[{"key":"head","label":"head","type":"array"},{"key":"val","label":"val","type":"number"}]}
          values={{ head: headInput, val: valInput }}
          onChange={(k, v) => { if (k === 'head') setHeadInput(v); if (k === 'val') setValInput(v); handleReset() }}
          showExamples={false}
