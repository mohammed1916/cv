...
export default function DistributeCandiesVisualizer() {
  ...
  return (
    <div className="distributeCandies-root">
      <div className="distributeCandies-card distributeCandies-input-card">
        <div className="distributeCandies-input-row">
          <div className="distributeCandies-field-group">
            <label className="distributeCandies-input-label">Input</label>
            <input className="distributeCandies-input" value={input} onChange={(e) => setInput(e.target.value)} placeholder="Enter input" />
          </div>
          <button className="distributeCandies-btn distributeCandies-btn-primary" onClick={handleVisualize}>
            Visualize
          </button>
        </div>
      </div>
