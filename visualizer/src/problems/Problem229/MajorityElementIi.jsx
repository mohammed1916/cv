...
export default function MajorityElementIi() {
  ...
  const panelContents = {
    left: (<div className="vis-panel majority-element-ii-panel">
            <div className="vis-panel-head majority-element-ii-panel-head">
              Input
              {inputError && <span style={{ color: '#ea0c0c', marginLeft: 8 }}>{inputError}</span>}
            </div>
            <div className="vis-panel-body majority-element-ii-panel-body">
              <div style={{ display: 'flex', gap: 6, marginBottom: 16, flexWrap: 'wrap' }}>
                {EXAMPLES.map((ex) => (
                  <button
                    key={ex.label}
                    onClick={() => applyExample(ex)}
                    className="vis-example-btn majority-element-ii-example-btn"
                  >
                    {ex.label}
                  </button>
                ))}
    ...
    right: (<div className="vis-panel majority-element-ii-panel">
            <div className="vis-panel-head majority-element-ii-panel-head">Details</div>
            <div className="vis-panel-body majority-element-ii-panel-body">
