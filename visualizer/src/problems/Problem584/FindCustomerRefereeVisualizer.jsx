...
export default function FindCustomerRefereeVisualizer() {
  ...
  return (
    <div className="findCustomerReferee-root">
      <div className="findCustomerReferee-card findCustomerReferee-input-card">
        <div className="findCustomerReferee-input-row">
          <div className="findCustomerReferee-field-group">
            <label className="findCustomerReferee-input-label">Input</label>
            <input className="findCustomerReferee-input" value={input} onChange={(e) => setInput(e.target.value)} placeholder="Enter input" />
          </div>
          <button className="findCustomerReferee-btn findCustomerReferee-btn-primary" onClick={handleVisualize}>
            Visualize
          </button>
        </div>
      </div>
