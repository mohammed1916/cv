...
import './CountStudentNumberVisualizer.css'
...
const EXAMPLES = getExamples('count-student-number')
...
export default function CountStudentNumberVisualizer() {
  ...
  return (
    <div className="countStudentNumber-root">
      <div className="countStudentNumber-card countStudentNumber-input-card">
        <div className="countStudentNumber-input-row">
          <div className="countStudentNumber-field-group">
            <label className="countStudentNumber-input-label">Input</label>
            <input className="countStudentNumber-input" value={input} onChange={(e) => setInput(e.target.value)} placeholder="Enter input" />
          </div>
          <button className="countStudentNumber-btn countStudentNumber-btn-primary" onClick={handleVisualize}>
            Visualize
          </button>
        </div>
      </div>
