...
import './FindCumulativeSalaryVisualizer.css'
...
const EXAMPLES = getExamples('find-cumulative-salary')
...
export default function FindCumulativeSalaryVisualizer() {
  ...
  return (
    <div className="findCumulativeSalary-root">
      <div className="findCumulativeSalary-card findCumulativeSalary-input-card">
        <div className="findCumulativeSalary-input-row">
          <div className="findCumulativeSalary-field-group">
            <label className="findCumulativeSalary-input-label">Input</label>
            <input className="findCumulativeSalary-input" value={input} onChange={(e) => setInput(e.target.value)} placeholder="Enter input" />
          </div>
          <button className="findCumulativeSalary-btn findCumulativeSalary-btn-primary" onClick={handleVisualize}>
            Visualize
          </button>
        </div>
      </div>
