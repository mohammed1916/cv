...
const EXAMPLES = getExamples('target-sum') || [
...
export default function Problem494Visualizer() {
  ...
  const SOLUTION_CODE = useSolutionCode('target-sum')
  ...
  const dockPanels = useMemo(() => [
    ...
    { id: 'viz', title: '🎯 Target Sum', content: (<VisualizationPanel nums={ex.nums} target={ex.target} step={step} applyEx={applyEx} />) },
