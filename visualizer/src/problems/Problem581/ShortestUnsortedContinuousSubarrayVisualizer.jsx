...
import './ShortestUnsortedContinuousSubarrayVisualizer.css'
...
const EXAMPLES = getExamples('shortest-unsorted-continuous-subarray')
...
export default function ShortestUnsortedContinuousSubarrayVisualizer() {
  ...
  return (
    <div className="shortestUnsortedContinuousSubarray-root">
      <div className="shortestUnsortedContinuousSubarray-card shortestUnsortedContinuousSubarray-input-card">
        <div className="shortestUnsortedContinuousSubarray-input-row">
          <div className="shortestUnsortedContinuousSubarray-field-group">
            <label className="shortestUnsortedContinuousSubarray-input-label">Input</label>
            <input className="shortestUnsortedContinuousSubarray-input" value={input} onChange={(e) => setInput(e.target.value)} placeholder="Enter input" />
          </div>
          <button className="shortestUnsortedContinuousSubarray-btn shortestUnsortedContinuousSubarray-btn-primary" onClick={handleVisualize}>
            Visualize
          </button>
        </div>
      </div>
