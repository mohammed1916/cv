...
const EXAMPLES = getExamplesOr('design-tic-tac-toe', [])
...
export default function DesignTicTacToeVisualizer() {
  ...
  const panelContents = {
    left: (<div className="design-tic--tac--toe-panel design-tic--tac--toe-panel-input">
            <div className="design-tic--tac--toe-panel-head">Input</div>
            <div className="design-tic--tac--toe-panel-body">
              <textarea
                value={inputValue}
                onChange={(e) => setInputValue(e.target.value)}
                className="design-tic--tac--toe-textarea"
                placeholder="Enter input..."
              />
            </div>
          </div>),
    right: (<div className="design-tic--tac--toe-panel design-tic--tac--toe-panel-viz">
            <div className="design-tic--tac--toe-panel-head">Visualization</div>
            <div className="design-tic--tac--toe-panel-body">
  ...
  return (
    <div className="design-tic--tac--toe-shell">
      <>
      ...
      <div className="design-tic--tac--toe-middle">
        ...
        <div className="design-tic--tac--toe-panel">
          <div className="design-tic--tac--toe-panel-head">Examples</div>
          <div className="design-tic--tac--toe-panel-body design-tic--tac--toe-examples">
