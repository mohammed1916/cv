...
const EXAMPLES = getExamples('intersection-of-two-arrays') || []
  ...
  return (
    <div className="intersectionof-two-arrays-shell">
      <ResizableSplitPanels
        left={
          <div className="intersectionof-two-arrays-panel intersectionof-two-arrays-panel-input">
        ...
        right={
          <div className="intersectionof-two-arrays-panel intersectionof-two-arrays-panel-viz">
      ...
      <div className="intersectionof-two-arrays-bottom">
        <PlaybackControls
          isPlaying={isPlaying}
