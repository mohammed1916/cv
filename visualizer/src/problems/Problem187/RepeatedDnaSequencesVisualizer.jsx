...
import './RepeatedDnaSequencesVisualizer.css'
...
const EXAMPLES = getExamples('repeated-dna-sequences')

export default function RepeatedDnaSequencesVisualizer() {
  ...
  return (
    <div className="repeated_dna_sequences-shell">
            ...
            <div className="repeated_dna_sequences-panel-body">
              <div style={{ display: "flex", gap: 6, marginBottom: 16, flexWrap: "wrap" }}>
                {EXAMPLES?.map((ex) => (
                  <button
                    ...
                    className="repeated_dna_sequences-example-btn"
                  >
                    {ex.label}
                  </button>
                )) || null}
              ...
              <div style={{ display: "flex", gap: 12, marginBottom: 24 }}>
                <input
                  ...
                  className="repeated_dna_sequences-input"
                  style={{ flex: 1 }}
                />
              </div>

              <div className="repeated_dna_sequences-visualization">
      ...
      <div className={`repeated_dna_sequences-status ${step?.phase === "done" ? "success" : ""}`}>
        {step?.message ?? "Press Play or Step to begin."}
      </div>

      <div className="repeated_dna_sequences-dock">
        <PlaybackControls
          isPlaying={isPlaying}
          isDone={isDone}
          speed={speed}
