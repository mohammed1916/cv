...
import './Problem277Visualizer.css'
...
export default function Problem277Visualizer() {
    const examples = useMemo(() => getExamplesOr('277', []), [])
...
const applyEx = useCallback((i) => { setCurrentExample(i); setInputInput(JSON.stringify(examples[i].input)); handleReset(); }, [handleReset]);
    ...
    return (
        <DockableWorkspace
            ...
            subtitle="find-the-celebrity"
            accentColor="#10b981"
        >
      
            <FloatingPanel title="Visualization" position="main">
                <div className="problem277-visualizer-viz-panel">
                    <div className="problem277-visualizer-canvas">
                        <motion.div
                            initial={{ opacity: 0 }}
                            animate={{ opacity: 1 }}
