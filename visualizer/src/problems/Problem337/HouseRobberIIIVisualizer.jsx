...
export default function HouseRobberIIIVisualizer() {
  ...
  const renderVisualization = () => {
    if (!input) return <div className="house-robber-i-i-i-error">{inputError}</div>
  ...
  return (
    <div className="house-robber-i-i-i-shell">
      <ResizableSplitPanels
        left={
          <div className="house-robber-i-i-i-panel house-robber-i-i-i-panel-input">
        ...
        right={
          <div className="house-robber-i-i-i-panel house-robber-i-i-i-panel-viz">
      ...
      <div className="house-robber-i-i-i-middle">
        <div className="house-robber-i-i-i-panel">
          <div className="house-robber-i-i-i-panel-head">Code Trace</div>
          <div className="house-robber-i-i-i-panel-body">
        ...
        <div className="house-robber-i-i-i-panel">
          <div className="house-robber-i-i-i-panel-head">Examples</div>
          <div className="house-robber-i-i-i-panel-body house-robber-i-i-i-examples">
      ...
      <div className="house-robber-i-i-i-bottom">
        <PlaybackControls
          isPlaying={isPlaying}
