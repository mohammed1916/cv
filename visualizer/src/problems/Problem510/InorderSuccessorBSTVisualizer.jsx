...
function VisualizationPanel({ values, target, step, applyEx }) {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 20, padding: 16 }}>
      ...
      {/* Tree Visualization */}
      <div>
        <div style={{ fontSize: 13, fontWeight: 600, color: 'var(--text)', marginBottom: 8 }}>Binary Search Tree</div>
      ...
      >
        ...
        <div style={{ fontSize: 20, fontWeight: 'bold', color: '#e0177a' }}>
...
export default function InorderSuccessorBSTVisualizer() {
  ...
  const panelConfigs = useMemo(() => [
    { id: 'code', title: 'Code' },
    { id: 'viz', title: '🌳 Inorder Successor in BST', dockMode: 'split-right' },
  ], [])
