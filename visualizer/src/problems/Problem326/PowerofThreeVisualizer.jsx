...
const EXAMPLES = getExamples('power-of-three') || []
  ...
  return (
    <div className="powerof-three-shell">
      <ResizableSplitPanels
        left={
          <div className="powerof-three-panel powerof-three-panel-input">
        ...
        right={
          <div className="powerof-three-panel powerof-three-panel-viz">
      ...
      <div className="powerof-three-middle">
        <div className="powerof-three-panel">
          <div className="powerof-three-panel-head">Code Trace</div>
          <div className="powerof-three-panel-body">
      ...
      <div className="powerof-three-bottom">
