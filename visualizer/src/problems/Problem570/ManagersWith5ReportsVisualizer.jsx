...
import './ManagersWith5ReportsVisualizer.css'
...
const EXAMPLES = getExamples('managers-with-5-reports')
...
export default function ManagersWith5ReportsVisualizer() {
  ...
  return (
    <div className="managersWith5Reports-root">
      <div className="managersWith5Reports-card managersWith5Reports-input-card">
        <div className="managersWith5Reports-input-row">
          <div className="managersWith5Reports-field-group">
            <label className="managersWith5Reports-input-label">Input</label>
            <input className="managersWith5Reports-input" value={input} onChange={(e) => setInput(e.target.value)} placeholder="Enter input" />
          </div>
          <button className="managersWith5Reports-btn managersWith5Reports-btn-primary" onClick={handleVisualize}>
            Visualize
          </button>
        </div>
      </div>
