    ...
    <div style={{ marginLeft: depth > 0 ? 24 : 0, marginTop: 12 }}>
      <motion.div
        style={{
          ...
          padding: "6px 12px",
          borderRadius: 4,
          backgroundColor: isHighlighted ? "#fbbf24" : isInSequence ? "#d1fae5" : "var(--border)",
          border: "2px solid " + (isHighlighted ? "#f59e0b" : isInSequence ? "#10b981" : "var(--text-muted)"),
          color: isHighlighted ? "#000" : "var(--text)",
          fontWeight: 600,
          fontSize: 12,
