...
export default function NumberofConnectedComponentsinanUndirectedGraphVisualizer() {
  ...
  const panelContents = {
    left: (<div className="numberof-connected-componentsinan-undirected-graph-panel numberof-connected-componentsinan-undirected-graph-panel-input">
    ...
    right: (<div className="numberof-connected-componentsinan-undirected-graph-panel numberof-connected-componentsinan-undirected-graph-panel-viz">
