...
const EXAMPLES = getExamples('connected-components-undirected') || []
...
export default function NumberofConnectedComponentsinanUndirectedGraphVisualizer() {
  ...
  const renderVisualization = () => {
    ...
    return (
      ...
      >
        <div className="numberof-connected-componentsinan-undirected-graph-step-info">
  ...
  return (
    <div className="numberof-connected-componentsinan-undirected-graph-shell">
      <ResizableSplitPanels
        left={
          <div className="numberof-connected-componentsinan-undirected-graph-panel numberof-connected-componentsinan-undirected-graph-panel-input">
            <div className="numberof-connected-componentsinan-undirected-graph-panel-head">Input</div>
            <div className="numberof-connected-componentsinan-undirected-graph-panel-body">
              <textarea
                value={inputValue}
                onChange={(e) => setInputValue(e.target.value)}
                className="numberof-connected-componentsinan-undirected-graph-textarea"
        ...
        right={
          <div className="numberof-connected-componentsinan-undirected-graph-panel numberof-connected-componentsinan-undirected-graph-panel-viz">
            <div className="numberof-connected-componentsinan-undirected-graph-panel-head">Visualization</div>
            <div className="numberof-connected-componentsinan-undirected-graph-panel-body">
