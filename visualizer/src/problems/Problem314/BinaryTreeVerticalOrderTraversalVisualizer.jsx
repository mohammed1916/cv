...
export default function BinaryTreeVerticalOrderTraversalVisualizer() {
  ...
  const panelContents = {
    left: (<div className="binary-tree-vertical-order-traversal-panel binary-tree-vertical-order-traversal-panel-input">
    ...
    right: (<div className="binary-tree-vertical-order-traversal-panel binary-tree-vertical-order-traversal-panel-viz">
