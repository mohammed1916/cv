...
export default function BinaryTreeVerticalOrderTraversalVisualizer() {
  ...
  return (
    <div className="binary-tree-vertical-order-traversal-shell">
      ...
      <div className="binary-tree-vertical-order-traversal-middle">
        <div className="binary-tree-vertical-order-traversal-panel">
          <div className="binary-tree-vertical-order-traversal-panel-head">Code Trace</div>
          <div className="binary-tree-vertical-order-traversal-panel-body">
        ...
        <div className="binary-tree-vertical-order-traversal-panel">
          <div className="binary-tree-vertical-order-traversal-panel-head">Examples</div>
      ...
      <div className="binary-tree-vertical-order-traversal-bottom">
