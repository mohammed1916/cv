...
import './SubtreeOfAnotherTreeVisualizer.css'
...
export default function SubtreeOfAnotherTreeVisualizer() {
  ...
  return (
    <div className="subtreeOfAnotherTree-root">
      <div className="subtreeOfAnotherTree-card subtreeOfAnotherTree-input-card">
        <div className="subtreeOfAnotherTree-input-row">
          <div className="subtreeOfAnotherTree-field-group">
            <label className="subtreeOfAnotherTree-input-label">Input</label>
            <input className="subtreeOfAnotherTree-input" value={input} onChange={(e) => setInput(e.target.value)} placeholder="Enter input" />
          </div>
          <button className="subtreeOfAnotherTree-btn subtreeOfAnotherTree-btn-primary" onClick={handleVisualize}>
            Visualize
          </button>
        </div>
      </div>
